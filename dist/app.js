...
var create_COVID19_data_1 = require("./function/create-COVID19-data");
...
function app() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    covid19 = new create_COVID19_data_1.COVID19(), exp = (0, express_1.default)(), port = process.env.PORT || 8080;
                    return [4 /*yield*/, covid19.update()];
                case 1:
                    _a.sent();
                    schema = (0, graphql_1.buildSchema)(covid19_schema_1.covid19Schema);
                    /**10분마다 데이터 업데이트*/
                            ...
                            /**args로 들어온 요청데이터에 따른 결과 반환*/
                            {
                                if (!region && !startDate && !endDate && !onlyLastDate) {
                                    ...
                                    regionalDataList = [
                                        ...
                                        ((0, fast_copy_1.default)(covid19.data.find(function (covid19Data) { return covid19Data.regionEng === region; }))),
                                    ];
                                }
                                else {
                                    regionalDataList = (0, fast_copy_1.default)(covid19.data);
                                }
                                if (!!startDate || !!endDate) {
                                    startDate = startDate ? startDate : 0;
                                    endDate = endDate ? endDate : (0, convert_format_1.date2query_form)(new Date());
                                    regionalDataList.forEach(function (regionalData) {
                                        regionalData.covid19DataList = regionalData.covid19DataList.filter(function (covid19Data) {
                                            var numDate = (0, convert_format_1.date2query_form)(covid19Data.date);
